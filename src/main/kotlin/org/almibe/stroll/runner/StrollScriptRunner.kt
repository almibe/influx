...
import org.almibe.stroll.loader.StrollScript

class StrollScriptRunner {
    fun runStrollScript(entityStore: PersistentEntityStore, commandArguments: StrollScript): String {
        TODO()
    }
